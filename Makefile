...
# Template: app
# Command: /work/Qt/5.4/gcc_64/bin/qmake -o Makefile asteroids.pro
#############################################################################
...
INCPATH       = -I../Qt/5.4/gcc_64/mkspecs/linux-g++ -I. -Isrc
QMAKE         = /work/Qt/5.4/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = asteroids1.0.0
DISTDIR = /work/asteroids/.tmp/asteroids1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/work/Qt/5.4/gcc_64
LIBS          = $(SUBLIBS) -lGL -lGLESv2 -lpng12 -ljansson -lSDL2 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: asteroids.pro ../Qt/5.4/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt/5.4/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt/5.4/gcc_64/mkspecs/common/shell-unix.conf \
		../Qt/5.4/gcc_64/mkspecs/common/unix.conf \
		../Qt/5.4/gcc_64/mkspecs/common/linux.conf \
		../Qt/5.4/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../Qt/5.4/gcc_64/mkspecs/features/lex.prf \
		asteroids.pro
	$(QMAKE) -o Makefile asteroids.pro
../Qt/5.4/gcc_64/mkspecs/features/spec_pre.prf:
../Qt/5.4/gcc_64/mkspecs/common/shell-unix.conf:
../Qt/5.4/gcc_64/mkspecs/common/unix.conf:
../Qt/5.4/gcc_64/mkspecs/common/linux.conf:
...
main.o: main.cpp src/GameAsteroids.h \
		src/defs.h \
		src/platform.h \
		src/VectorPtr.h \
		src/Point3f.h \
...
Hero.o: src/Hero.cpp src/Hero.h \
		src/Sprite.h \
		src/Object.h \
		src/defs.h \
		src/platform.h \
		...
		src/VBO.h \
		src/Rect.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Hero.o src/Hero.cpp

Asteroid.o: src/Asteroid.cpp src/Asteroid.h \
		src/Sprite.h \
		src/Object.h \
		src/defs.h \
		src/platform.h \
		...
		src/VBO.h \
		src/Rect.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Asteroid.o src/Asteroid.cpp
...
Atlas.o: src/Atlas.cpp src/Atlas.h \
		src/InfoSprite.h \
		src/Rect.h \
		src/defs.h \
		src/platform.h \
		src/Utils.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Atlas.o src/Atlas.cpp

Screen1.o: src/Screen1.cpp src/Screen1.h \
		src/Object.h \
		src/defs.h \
		src/platform.h \
		src/VectorPtr.h \
		...
		src/Rect.h \
		src/Button.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Screen1.o src/Screen1.cpp

InfoSprite.o: src/InfoSprite.cpp src/InfoSprite.h \
		src/Rect.h \
		src/defs.h \
		src/platform.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o InfoSprite.o src/InfoSprite.cpp
...
GameAsteroids.o: src/GameAsteroids.cpp src/GameAsteroids.h \
		src/defs.h \
		src/platform.h \
		src/VectorPtr.h \
		src/Point3f.h \
		...
		src/Screen1.h \
		src/Object.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o GameAsteroids.o src/GameAsteroids.cpp

VBO.o: src/VBO.cpp src/defs.h \
		src/platform.h \
		src/VBO.h \
		src/Rect.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o VBO.o src/VBO.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/asteroids/bin || mkdir -p $(INSTALL_ROOT)/opt/asteroids/bin
	-$(INSTALL_PROGRAM) "$(QMAKE_TARGET)" "$(INSTALL_ROOT)/opt/asteroids/bin/$(QMAKE_TARGET)"
	-$(STRIP) "$(INSTALL_ROOT)/opt/asteroids/bin/$(QMAKE_TARGET)"

uninstall_target: FORCE
	-$(DEL_FILE) "$(INSTALL_ROOT)/opt/asteroids/bin/$(QMAKE_TARGET)"
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/asteroids/bin/ 
